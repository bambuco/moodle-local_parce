...
- "course": questions about the current course identity or visible structure: course name, short name, how many sections it has, section names, which resources and activities the user can see, course start and end dates, the user\'s enrolment start and end in the course, or public course custom fields. Use this for inventory or overview questions, not to open a single link.
...
$string['intent_help_course'] = 'You are in a course context. You can ask me the course name, how many sections it has, which visible resources you can access, course dates, your enrolment dates, public course custom fields, or questions about course content, assignments, grades, progress or calendar dates. Just type your question and I\'ll do my best to help!';
...
$string['intent_help_module'] = 'You are currently in a module context. You can ask me the course name, how many sections it has, which visible resources you can access, course dates, your enrolment dates, public course custom fields, or questions related to this module\'s content, dates, grades or progress. Just type your question and I\'ll do my best to assist you!';
