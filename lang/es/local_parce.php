...
$string['default_answer_question_prompt'] = 'Responde a la pregunta del usuario de manera precisa, clara y concisa. Usando únicamente el texto de "content" y considerando el historial de "previous". Proporciona solo información adecuada para un contexto educativo. Si hay enlaces, coloca las referencias al pie. Si no estás seguro de la respuesta, di que no lo sabes. No busques en bases públicas, limítate al contenido proporcionado.';
$string['default_question_plan_prompt'] = 'Basado en el JSON del usuario, responde con un JSON válido que contenga:\n"type": debe ser uno de: greeting, content, dates\n"params": Para el tipo "content" las palabras clave que definen el contenido a buscar, para fechas los rangos de fechas, para "greeting" un saludo aleatorio+respetuoso+cordial+creativo\nResponde solo el JSON puro, sin bloques de código, sin markdown y sin texto adicional.';
