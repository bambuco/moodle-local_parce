...
- "course": preguntas sobre la identidad o la estructura visible del curso actual: nombre, nombre corto, cuántas secciones tiene, nombres de secciones, qué recursos y actividades puede ver el usuario, fechas de inicio y fin del curso, inicio y fin de su matrícula, o campos personalizados públicos del curso. Úsala para inventario o resumen, no para abrir un solo enlace.
...
$string['intent_help_course'] = '¡Estás en un contexto de curso! Puedes preguntarme el nombre del curso, cuántas secciones tiene, qué recursos visibles puedes ver, las fechas del curso, las fechas de tu matrícula, los campos personalizados públicos, o hacer preguntas sobre el contenido, las tareas, las calificaciones, el progreso o el calendario. Solo escribe tu pregunta y haré lo mejor posible para ayudarte.';
...
$string['intent_help_module'] = '¡Actualmente estás en un contexto de módulo! Puedes preguntarme el nombre del curso, cuántas secciones tiene, qué recursos visibles puedes ver, las fechas del curso, las fechas de tu matrícula, los campos personalizados públicos, o hacer preguntas sobre el contenido de este módulo, las fechas, las calificaciones o el progreso. Solo escribe tu pregunta y haré lo mejor posible para asistirte.';
